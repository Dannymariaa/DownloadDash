# DownloadDash Pinterest API

## Overview
Resolve public Pinterest pins, images, and videos.

## Features
- Resolve public pin media
- Support image and video responses
- Return metadata for visual archive workflows
...
## Pricing Suggestions
Free plan for tests, paid monthly tiers by request volume.

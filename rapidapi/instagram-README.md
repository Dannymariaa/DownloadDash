# DownloadDash Instagram API

## Overview
Resolve public Instagram reels, videos, photos, and carousel media.

## Features
- Resolve public reels and posts
- Return metadata and available media links
- Support image, video, and carousel workflows
...
## Pricing Suggestions
Free plan for testing, then usage-based Basic, Pro, and Ultra tiers.

# DownloadDash Facebook API

## Overview
Resolve public Facebook videos and media URLs for download workflows.

## Features
- Resolve public Facebook video URLs
- Return direct media and metadata when available
- Support high quality output preference
...
## Pricing Suggestions
Free testing tier, then monthly Basic, Pro, and Business plans by request volume.

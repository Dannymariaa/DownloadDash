  ...
  const handleSaveSelected = async () => {
        ...
        for (const id of selectedItems) {
          ...
          if (item) {
            await downloadDash.entities.SavedContent.create({
              ...
              title: `WhatsApp Business Status - ${item.timestamp}`
            });
          }
        }
      } catch {
    ...
    try {
      ...
      for (const id of selectedItems) {
        ...
        const filename = item.filename || `whatsapp_business_${item.type}_${Date.now()}`;
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        >
          ...
          <p className="text-gray-400 text-lg mb-2">
            Save status videos and images from your business contacts
          </p>
          
          <div className="flex flex-wrap justify-center gap-2 mb-6">
            {['Status Videos', 'Status Images', 'Business Accounts', 'Save to Gallery'].map((tag, idx) => (
              <span 
                key={idx}
        ...
        >
          ...
          <div className="grid md:grid-cols-3 gap-4">
            {[
              { step: '1', icon: <Smartphone className="h-6 w-6" />, text: 'View status in WhatsApp Business app' },
        ...
        >
          ...
          {!statusLoadError && !isStatusLoading && (activeTab === 'images' ? statusItems.images.length === 0 : statusItems.videos.length === 0) && (
            <div className="mt-6 text-center text-gray-500 text-sm">
              No {activeTab} found yet. View a status in WhatsApp Business, keep the bridge connected, then refresh.
            </div>
          )}
        ...
        >
          ...
          <div className="text-sm text-gray-400">
            ...
            <p>You must first view the status in WhatsApp Business for it to appear here. WhatsApp Business temporarily saves viewed statuses on your device, which this app can access to help you save them permanently.</p>
          </div>
        </motion.div>
